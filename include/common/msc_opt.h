...
#define _msc_opt_h_
	...
	#pragma warning(disable: 4239)	/* CWalkIntelligentPtr<TYPE> ptr; ptr = CWalkIntelligentPtr<TYPE>(1); */
	...
	#pragma warning(error: 4541)	/* 'dynamic_cast' used on polymorphic type 'class XXX' with /GR-; ucwslbedictable behavior may result */
