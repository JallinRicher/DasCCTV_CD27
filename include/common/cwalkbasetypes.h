...
#ifndef _cwalkbasetypes_h_
#define _cwalkbasetypes_h_
...
typedef unsigned short				UINT16;
	...
	#define U64CONST(x)				x
#else
	#if 32==cwslb_SYS_BITS || 64==cwslb_SYS_BITS
		typedef int					INT32;
		typedef unsigned int		UINT32;
	#else
...
#if defined(_CWALK_IS_LINUX) && 64==cwslb_SYS_BITS
	typedef unsigned int			DWORD;
#else
	typedef unsigned long			DWORD;
#endif

#if 16==cwslb_SYS_BITS
	typedef short					INT_PTR;
	typedef unsigned short			UINT_PTR;
#elif 32==cwslb_SYS_BITS
	#if !defined(WIN32)
		typedef int					INT_PTR;
		typedef unsigned int		UINT_PTR;
	#endif
#elif 64==cwslb_SYS_BITS
...
#endif	/* #ifndef _cwalkbasetypes_h_ */
